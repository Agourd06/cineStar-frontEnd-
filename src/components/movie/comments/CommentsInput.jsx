        ...
        <section className="min-h-[40vh] relative py-4 px-4 lg:px-0">
            <div className="  xl:max-w-7xl lg:max-w-5xl max-w-lg md:max-w-3xl mx-auto text-white">
                <div className="max-w-3xl lg:max-w-full mx-auto ">
                    <h1 className=' xl:max-w-7xl lg:max-w-5xl max-w-lg md:max-w-3xl mx-auto text-text md:text-5xl text-2xl font-extrabold py-1'>Comments  </h1>
                </div>
                <div className=" lg:ml-10 flex md:flex-row flex-col gap-5 justify-center mt-9  items-center ">
                    <p className='flex items-center gap-2'><i className='bx bxs-error text-[#df2144]' ></i> Dear user, you must be logged to publish
                        your opinion. </p>
                    <div className="flex gap-4">
                        <a href="/login"
                            className="lg:px-6 px-4 py-2 rounded-md  text-[#EEBB07] duration-500 hover:text-black text-sm border-black border tracking-wider font-semibold  outline-none bg-[#303030] hover:bg-[#EEBB07] "><i
                                className='bx bx-log-in text-white' ></i> Log in</a>
                        <a href="/login"
                            className="lg:px-6 px-4 py-2 rounded-md flex items-center gap-2  text-[#EEBB07] duration-500 hover:text-black text-sm border-black border tracking-wider font-semibold  outline-none bg-[#303030] hover:bg-[#EEBB07] "><i
                                className='bx bx-user-plus'></i> Register</a>
                    </div>
                ...
                <div className="relative w-full mt-7 min-w-[200px]  rounded-full ">
                    <form onSubmit={(e) => {
                        ...
                        <textarea name="content" id="newComment" onChange={handleChange} value={formData.content}
            ...
            <CommentsData newComment={commentData?.comment} MovieId={MovieId}/>
        </section>
