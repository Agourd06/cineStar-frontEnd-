                ...
                <div className="relative flex flex-col h-full">
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 px-2 flex-1">
                            <li>
                                <a href="/dashboard" className="text-gray-300 text-sm flex items-center hover:text-[#EEBB07] transition-all">
                    ...
                    <div className="flex-1">
                        ...
                        <ul className="space-y-4 px-2 flex-1">
                            ...
                            <li>
                                <a href="/movie-manage" className="text-gray-300 text-sm flex items-center hover:text-[#EEBB07] transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-4 h-4 mr-4"
                            ...
                            <li>
                                <a href="/session-manage" className="text-gray-300 text-sm flex items-center hover:text-[#EEBB07] transition-all">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-4 h-4 mr-4"
                                        viewBox="0 0 193.769 193.769">
                                        <path
                                            d="m149.203 41.104-9.348 12.009c20.15 15.679 30.201 41.063 26.234 66.253-2.906 18.484-12.838 34.73-27.964 45.748-15.131 11.012-33.64 15.488-52.124 12.567-38.157-6.008-64.32-41.938-58.322-80.098C30.585 79.097 40.52 62.85 55.648 51.835c13.208-9.615 28.991-14.233 45.086-13.317L87.579 52.319l9.759 9.313 20.766-21.801.005.008 9.303-9.769-9.752-9.303-.005.003L95.862 0l-9.31 9.769 14.2 13.525c-19.303-.913-38.21 4.702-54.059 16.242C28.28 52.943 16.19 72.717 12.65 95.221c-7.302 46.445 24.54 90.184 70.985 97.493a86.181 86.181 0 0 0 13.434 1.055c17.89 0 35.273-5.623 50.011-16.356 18.415-13.409 30.503-33.183 34.043-55.682 4.829-30.654-7.403-61.55-31.92-80.627z"
                    ...
                    <div className="mt-4">
                        ...
                        <div className="flex  items-center cursor-pointer border-t border-[#EEBB07] py-2  mt-6">
                            {/* <img src='' className="w-10 h-10 rounded-md border-2 border-white" />
                            <div className="ml-4">
                                <p className="text-sm text-gray-300 font-semibold">John Doe</p>
                                <p className="text-xs text-white mt-0.5">Active free account</p>
                            </div> */}
                            <button onClick={logout} className='text-sm text-gray-300 font-semibold w-full flex gap-2 items-center pl-2 pt-1'><i class='bx bx-log-out'></i>Logout</button>
                        </div>
                    </div>
                </div>
            </nav>
